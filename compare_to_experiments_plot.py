...
plt.bar(x-0.5*bar_width,P_expr_kips, label='Experiment' ,width=bar_width)
plt.bar(x+0.5*bar_width,P_GMNIA_kips,label='Analysis'   ,width=bar_width)
...
plt.grid(axis='y', which='minor',linestyle=':', color='lightgrey', zorder=3)
plt.grid(axis='y', which='major',linestyle='-', zorder=3)
plt.savefig(os.path.join('figures', 'strength_bar_chart_US.png'), dpi=200)
